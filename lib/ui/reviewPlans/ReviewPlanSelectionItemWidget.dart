  ...
  Widget build(BuildContext context) {
    return RoundCornerPanelWidget(
      ...
      child: ItemContentWidget(
        ...
        onInfoIconClicked: (reviewPlanName) async {
